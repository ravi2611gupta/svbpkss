	...
	<!-- /page header -->
            ...
            $sql="select * from tbl_dep where flag='com'";
            ...
            if($result>0)
            {
                ...
                {?>
                    ...
                    <?php echo $row['p_msg'] ?>
                        ...
                        <input type="submit" name="com_update" value="Update Content" class="btn-success">
                    </form>
                <?php
                }
            }
	...
	<form action="all.php" method="POST" enctype="multipart/form-data">		
		Upload photo: (File Should Be in .jpg/.gif/.png Format)<input type="file" name="pimg" onChange="validextension1(this);"> <input type="submit" name="com_update_img" value="Update Image" class="btn-success">
	</form>
