<?php
	...
	$q_acal = "select * from time_table where type='time table' order by t_id desc";
				...
				<table class="table text-center table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="admin/<?php echo $row_acal['time_table_file']; ?>" target="_blank">Click here to view</a></td>
